...
createIdentityPool = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "createIdentityPool"
...
deleteIdentities = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "deleteIdentities"
...
deleteIdentityPool = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "deleteIdentityPool"
...
describeIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "describeIdentity"
...
describeIdentityPool = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "describeIdentityPool"
...
getCredentialsForIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "getCredentialsForIdentity"
...
getId = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "getId"
...
getIdentityPoolRoles = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "getIdentityPoolRoles"
...
getOpenIdToken = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "getOpenIdToken"
...
getOpenIdTokenForDeveloperIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "getOpenIdTokenForDeveloperIdentity"
...
listIdentityPools = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "listIdentityPools"
...
lookupDeveloperIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "lookupDeveloperIdentity"
...
mergeDeveloperIdentities = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "mergeDeveloperIdentities"
...
setIdentityPoolRoles = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "setIdentityPoolRoles"
...
unlinkDeveloperIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "unlinkDeveloperIdentity"
...
unlinkIdentity = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "unlinkIdentity"
...
updateIdentityPool = Request.request service method  where
    service = Request.ServiceName "CognitoIdentity"
    method = Request.MethodName "updateIdentityPool"
